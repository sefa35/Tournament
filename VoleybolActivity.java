...
public class VoleybolActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_voleybol);
        ...
        final Takım VoleybolBilgisayar=new Takım();
        final Takım VoleybolEndustri=new Takım();
        final Takım VoleybolElektronik=new Takım();
        final Takım VoleybolJeofizik=new Takım();
        final Takım VoleybolInsaat=new Takım();
        final Takım VoleybolMaden=new Takım();
        final Takım VoleybolCevre=new Takım();
        final Takım VoleybolMakine=new Takım();
        final Takım VoleybolTekstil=new Takım();
        final Takım VoleybolJeoloji=new Takım();
        final Takım VoleybolMalzeme=new Takım();

        Takımlar[0]=VoleybolBilgisayar;
        Takımlar[1]=VoleybolEndustri;
        Takımlar[2]=VoleybolElektronik;
        Takımlar[3]=VoleybolJeofizik;
        Takımlar[4]=VoleybolInsaat;
        Takımlar[5]=VoleybolMaden;
        Takımlar[6]=VoleybolCevre;
        Takımlar[7]=VoleybolMakine;
        Takımlar[8]=VoleybolTekstil;
        Takımlar[9]=VoleybolJeoloji;
        Takımlar[10]=VoleybolMalzeme;


        //Adlandırma
        VoleybolBilgisayar.setAd("Bilgisayar");
        VoleybolEndustri.setAd("Endustri");
        VoleybolElektronik.setAd("Elektronik");
        VoleybolJeofizik.setAd("Jeofizik");
        VoleybolInsaat.setAd("Insaat");
        VoleybolMaden.setAd("Maden");
        VoleybolCevre.setAd("Cevre");
        VoleybolMakine.setAd("Makine");
        VoleybolTekstil.setAd("Tekstil");
        VoleybolJeoloji.setAd("Jeoloji");
        VoleybolMalzeme.setAd("Malzeme");
        ...
        while(i<Takımlar.length/2){
            ...
            if(Takım1id!=Takım2id){
                ...
                Fikstur0[i] =Hakem.VoleybolMacYap(Takım1,Takım2);
                i++;
            }
        ...
        while(i<3){
            ...
            if(Takım1id!=Takım2id){
                ...
                Fikstur1[i] =Hakem.VoleybolMacYap(Takım1,Takım2);
                i++;
            }
        ...
        while(i<1){
            ...
            if(Takım1id!=Takım2id){
                ...
                Fikstur2[i] =Hakem.VoleybolMacYap(Takım1,Takım2);
                i++;
            }
        }
        ...
        //final macı
        Fikstur3[0] =Hakem.VoleybolMacYap(Takımlar3[0],Takımlar3[1]);
        ...
        button4.setOnClickListener(new View.OnClickListener() {
            ...
            String asd="Voleybol Turnuvası Sampiyonu :";
            @Override
            public void onClick(View v) {
