...
public class Takım {
    ...
    public Takım(String ad, String bolum, int skor,int toplamSkor,int avaraj, int tur, boolean kazandı) {
        Ad = ad;
        Bolum = bolum;
        Skor = skor;
        Avaraj=avaraj;
    ...
    public String FutbolMacYap(Takım Takım1, Takım Takım2){
    ...
    public String BasketbolMacYap(Takım Takım1, Takım Takım2){
    ...
    public String HentbolMacYap(Takım Takım1, Takım Takım2){
    ...
    public String VoleybolMacYap(Takım Takım1, Takım Takım2){

        Takım1.Skor=SayıUret.nextInt(6);
        Takım2.Skor=5-Takım1.Skor;
        if (Takım1.Skor==Takım2.Skor){
            ++Takım1.Skor;
        }
        if (Takım1.Skor>Takım2.Skor){
    ...
    public String MasatenisiMacYap(Takım Takım1, Takım Takım2){
