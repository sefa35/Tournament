...
public class BasketbolActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Takım BasketbolBilgisayar=new Takım();
        final Takım BasketbolEndustri=new Takım();
        final Takım BasketbolElektronik=new Takım();
        final Takım BasketbolJeofizik=new Takım();
        final Takım BasketbolInsaat=new Takım();
        final Takım BasketbolMaden=new Takım();
        final Takım BasketbolCevre=new Takım();
        final Takım BasketbolMakine=new Takım();
        final Takım BasketbolTekstil=new Takım();
        final Takım BasketbolJeoloji=new Takım();
        final Takım BasketbolMalzeme=new Takım();

        Takımlar[0]=BasketbolBilgisayar;
        Takımlar[1]=BasketbolEndustri;
        Takımlar[2]=BasketbolElektronik;
        Takımlar[3]=BasketbolJeofizik;
        Takımlar[4]=BasketbolInsaat;
        Takımlar[5]=BasketbolMaden;
        Takımlar[6]=BasketbolCevre;
        Takımlar[7]=BasketbolMakine;
        Takımlar[8]=BasketbolTekstil;
        Takımlar[9]=BasketbolJeoloji;
        Takımlar[10]=BasketbolMalzeme;


        //Adlandırma
        BasketbolBilgisayar.setAd("Bilgisayar");
        BasketbolEndustri.setAd("Endustri");
        BasketbolElektronik.setAd("Elektronik");
        BasketbolJeofizik.setAd("Jeofizik");
        BasketbolInsaat.setAd("Insaat");
        BasketbolMaden.setAd("Maden");
        BasketbolCevre.setAd("Cevre");
        BasketbolMakine.setAd("Makine");
        BasketbolTekstil.setAd("Tekstil");
        BasketbolJeoloji.setAd("Jeoloji");
        BasketbolMalzeme.setAd("Malzeme");
        ...
        while(i<Takımlar.length/2){
            ...
            if(Takım1id!=Takım2id){
                ...
                Fikstur0[i] =Hakem.BasketbolMacYap(Takım1,Takım2);
                i++;
            }
        ...
        while(i<3){
            ...
            if(Takım1id!=Takım2id){
                ...
                Fikstur1[i] =Hakem.BasketbolMacYap(Takım1,Takım2);
                i++;
            }
        ...
        while(i<1){
            ...
            if(Takım1id!=Takım2id){
                ...
                Fikstur2[i] =Hakem.BasketbolMacYap(Takım1,Takım2);
                i++;
            }
        }
        ...
        //final macı
        Fikstur3[0] =Hakem.BasketbolMacYap(Takımlar3[0],Takımlar3[1]);
        ...
        button4.setOnClickListener(new View.OnClickListener() {
            ...
            String asd="Basketbol Turnuvası Sampiyonu :";
            @Override
            public void onClick(View v) {
