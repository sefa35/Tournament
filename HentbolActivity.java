...
public class HentbolActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hentbol);
        ...
        final Takım HentbolBilgisayar=new Takım();
        final Takım HentbolEndustri=new Takım();
        final Takım HentbolElektronik=new Takım();
        final Takım HentbolJeofizik=new Takım();
        final Takım HentbolInsaat=new Takım();
        final Takım HentbolMaden=new Takım();
        final Takım HentbolCevre=new Takım();
        final Takım HentbolMakine=new Takım();
        final Takım HentbolTekstil=new Takım();
        final Takım HentbolJeoloji=new Takım();
        final Takım HentbolMalzeme=new Takım();

        Takımlar[0]=HentbolBilgisayar;
        Takımlar[1]=HentbolEndustri;
        Takımlar[2]=HentbolElektronik;
        Takımlar[3]=HentbolJeofizik;
        Takımlar[4]=HentbolInsaat;
        Takımlar[5]=HentbolMaden;
        Takımlar[6]=HentbolCevre;
        Takımlar[7]=HentbolMakine;
        Takımlar[8]=HentbolTekstil;
        Takımlar[9]=HentbolJeoloji;
        Takımlar[10]=HentbolMalzeme;


        //Adlandırma
        HentbolBilgisayar.setAd("Bilgisayar");
        HentbolEndustri.setAd("Endustri");
        HentbolElektronik.setAd("Elektronik");
        HentbolJeofizik.setAd("Jeofizik");
        HentbolInsaat.setAd("Insaat");
        HentbolMaden.setAd("Maden");
        HentbolCevre.setAd("Cevre");
        HentbolMakine.setAd("Makine");
        HentbolTekstil.setAd("Tekstil");
        HentbolJeoloji.setAd("Jeoloji");
        HentbolMalzeme.setAd("Malzeme");
        ...
        while(i<Takımlar.length/2){
            ...
            if(Takım1id!=Takım2id){
                ...
                Fikstur0[i] =Hakem.HentbolMacYap(Takım1,Takım2);
                i++;
            }
        ...
        while(i<3){
            ...
            if(Takım1id!=Takım2id){
                ...
                Fikstur1[i] =Hakem.HentbolMacYap(Takım1,Takım2);
                i++;
            }
        ...
        while(i<1){
            ...
            if(Takım1id!=Takım2id){
                ...
                Fikstur2[i] =Hakem.HentbolMacYap(Takım1,Takım2);
                i++;
            }
        }
        ...
        //final macı
        Fikstur3[0] =Hakem.HentbolMacYap(Takımlar3[0],Takımlar3[1]);
        ...
        button4.setOnClickListener(new View.OnClickListener() {
            ...
            String asd="Hentbol Turnuvası Sampiyonu :";
            @Override
            public void onClick(View v) {
